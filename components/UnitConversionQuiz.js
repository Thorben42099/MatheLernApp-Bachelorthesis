...
/**
 * UnitConversionQuiz Komponente
 * 
 * Eine Komponente, die ein Quiz rendert, bei dem Benutzer eine Option auswählen müssen, um eine Einheit umzuwandeln.
 * 
 * Props:
  ...
  return (
    <View>
      <View style={styles.questionContainer}>
        <Image source={require('../assets/FrageEuleUnitConversion.png')} style={styles.questionImage} />
      </View>
